...
export class ReservationQueryDto {
	...
	@ApiProperty({ description: 'Filter by start date', example: '2023-01-01', required: false })
	@IsOptional()
	@IsDateString({}, { message: '시작 날짜는 유효한 날짜 형식이어야 합니다.' })
	startDate?: string;

	@ApiProperty({ description: 'Filter by end date', example: '2023-01-31', required: false })
	@IsOptional()
