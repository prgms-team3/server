...
export class InvitationHistory {
  ...
  @ApiProperty({ description: 'Invitation status', example: InvitationStatus.SENT, enum: InvitationStatus })
  ...
  @ManyToOne(() => WorkspaceInvitationCode, (invitationCode) => invitationCode.invitationHistories)
